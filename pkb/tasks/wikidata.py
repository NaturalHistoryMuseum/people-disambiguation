...
class WikiDataCollectorsTask(BaseTask):    
    ...
    def run(self):
        ...
        # Prepare CSV header
        fieldnames = [
            'qid', 'name', 'aliases', 'birthName', 'dateOfBirth', 'dateOfDeath',
            'VIAF', 'authorAbbrv', 'harvardIndex', 'bionomia', 'IPNI', 'ISNI',
            'employers', 'countriesOfCitizenship', 'employerCountries', 'sexOrGender']
    ...
    def output(self): 
        return luigi.LocalTarget(INTERMEDIATE_DIR / 'wikidata' / 'collectors.csv')      
